...
class MoviePopUp extends Component {
    ...
    onAxiosLoad(response) {
        ...
        background.style.background = 'url(\"http://img.omdbapi.com/?apikey=bbe6ac46&' + this.props.movie.poster_path + '\") no-repeat';
        ...
        content.innerHTML = "<img class=\"poster-inside\" src=\"http://img.omdbapi.com/?apikey=bbe6ac46&" + this.props.movie.poster_path + "\"/>" +
